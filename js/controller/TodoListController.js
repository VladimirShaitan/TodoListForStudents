export class TodoListController {
    ...
    constructor(formConfiguration, ViewClass, ModelClass) {
        ...
        this.todoContainer = TodoListController.#getElementFromDOM(this.todosContainerSelector);
        this.#setChangeStatusEvent();
        this.#setRemoveItemEvent();

        this.clearAllBtn = TodoListController.#getElementFromDOM(this.removeBtnSelector);
